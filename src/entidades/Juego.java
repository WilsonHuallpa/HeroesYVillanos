...
public final class Juego{
     ...
     * */
    public List<Personaje> ordernarPersonajes(Comparator c){
        //List<Personaje> listadoOrdenado = enfrentables.stream().sorted(Comparator.comparing(c)).collect(Collectors.toList());
